...
// This file provides calculation functions for technical indicators

/**
 * Calculate Simple Moving Average (SMA)
 * @param {Array} data - Array of objects with {time, value} or {time, close} properties
 * @param {number} period - SMA period
 * @returns {Array} Array of objects with {time, value} properties (null for insufficient data)
 */
 ...
 * @returns {Array} Array of objects with {time, upper, middle, lower} properties
 */
 ...
 * @returns {Array} Array of objects with {time, macd, signal, histogram} properties
 */
